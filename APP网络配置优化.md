...
## 安全
#### TLS 1.3
￼![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/tls1_3_1.jpeg?raw=true "tls1.3")-
#### 防止中间人攻击  
...
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2010.jpeg?raw=true "正规CA证书验证流程")
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2011.jpeg?raw=true "tls1.3")
#### API Choices  
Apple给出的几种写网络时可以使用的API选择
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2012.jpeg?raw=true "API Choices")
...
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2013.jpeg?raw=true "URLSession")
## 网络优化方面
#### 网络延迟 Lantency
...
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2014.jpeg?raw=true "HTTP/2")
HTTP/2的**TCP连接多路复用、设置请求优先级、压缩请求头**优化了网络资源，提高了带宽利用率。
![Alt text](https://github.com/geekxing/myStudy/blob/master/resources/Pasted%20Graphic%2015.jpeg?raw=true "减少请求数据包的大小")
#### 网络响应 Responsiveness
